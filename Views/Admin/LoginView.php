                ...
                <div class="signin-form">
                    ...
                    <form class="user" method="post" action="login-admin">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user" id="exampleInputEmail" placeholder="Your Name"
                                value="<?php if(isset($_COOKIE["user"])) { echo $_COOKIE["user"]; } ?>"
                                style="background-color: #f1f5f7;" required />
                        </div>
                        <div class="form-group">
                            <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                            <input type="password" name="pass" id="exampleInputPassword" placeholder="Password"
                                value="<?php if(isset($_COOKIE["passad"])) { echo $_COOKIE["passad"]; } ?>"
                                style="background-color: #f1f5f7;" required />
                        </div>
                        <div class="form-group">
                            <input type="checkbox" name="remember" id="customCheck" class="agree-term"
                                <?php if(isset($_COOKIE["rememberad"])) { echo 'checked'; } ?> />
                            <label for="remember-me" class="label-agree-term"><span><span></span></span>Remember
                                me</label>
                        </div>
                        <div class="form-group form-button" style="align-content: center;">
                            <input type="submit" name="signin" id="signin" style="align-content: center;"
